...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-name { font-family: 'Arial', sans-serif; font-size: 22px; font-weight: 800; letter-spacing: 2px; color: #1a1a2e; text-transform: uppercase; }
    .brand-sub { font-family: 'Arial', sans-serif; font-size: 11px; color: #888; letter-spacing: 1px; text-transform: uppercase; margin-top: 2px; }
    .doc-meta { text-align: right; font-family: 'Arial', sans-serif; font-size: 12px; color: #666; line-height: 1.6; }
    .doc-meta strong { display: block; font-size: 13px; color: #1a1a2e; }
    .title-block { text-align: center; margin-bottom: 36px; }
    .title-block h1 { font-family: 'Arial', sans-serif; font-size: 20px; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; color: #1a1a2e; margin-bottom: 6px; }
    .title-block .subtitle { font-size: 13px; color: #666; font-style: italic; }
    .parties-box { background: #f8f8f6; border: 1px solid #e0e0da; border-left: 4px solid #1a1a2e; padding: 24px 28px; margin-bottom: 32px; border-radius: 2px; }
    .parties-box h2 { font-family: 'Arial', sans-serif; font-size: 11px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; color: #888; margin-bottom: 16px; }
    .party-row { display: grid; grid-template-columns: 1fr 1fr; gap: 24px; }
    .party { font-size: 13px; }
    .party-label { font-family: 'Arial', sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; color: #999; margin-bottom: 4px; }
    .party-name { font-weight: 700; font-size: 15px; color: #1a1a2e; margin-bottom: 2px; }
    .party-detail { color: #555; line-height: 1.5; }
    .summary-table { width: 100%; border-collapse: collapse; margin-bottom: 32px; font-size: 13px; }
    .summary-table th { font-family: 'Arial', sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; color: #999; text-align: left; padding: 8px 12px; background: #f8f8f6; border: 1px solid #e0e0da; }
    .summary-table td { padding: 10px 12px; border: 1px solid #e0e0da; vertical-align: top; }
    .summary-table tr:nth-child(even) td { background: #fafaf8; }
    .fee-highlight { font-weight: 700; color: #1a1a2e; font-size: 15px; }
    .recital { background: #fafaf8; border: 1px solid #e8e8e2; padding: 20px 24px; margin-bottom: 32px; font-size: 13px; color: #444; border-radius: 2px; }
    .section-heading { font-family: 'Arial', sans-serif; font-size: 12px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; color: #1a1a2e; margin-top: 32px; margin-bottom: 12px; padding-bottom: 6px; border-bottom: 1px solid #e0e0da; }
    .clause { display: grid; grid-template-columns: 28px 1fr; gap: 8px; margin-bottom: 14px; font-size: 13.5px; color: #2c2c2c; }
    .clause-num { font-family: 'Arial', sans-serif; font-weight: 700; color: #999; font-size: 12px; padding-top: 2px; text-align: right; }
    .clause-text ul { margin-top: 8px; padding-left: 20px; }
    .clause-text ul li { margin-bottom: 6px; }
    .clause-sub-heading { display: grid; grid-template-columns: 28px 1fr; gap: 8px; margin-top: 16px; margin-bottom: 8px; }
    .clause-sub-heading .clause-text { font-family: 'Arial', sans-serif; font-size: 12px; font-weight: 700; letter-spacing: 0.5px; color: #444; text-decoration: underline; }
    .signature-section { margin-top: 52px; padding-top: 32px; border-top: 1px solid #ddd; }
    .signature-section h2 { font-family: 'Arial', sans-serif; font-size: 11px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; color: #888; margin-bottom: 24px; text-align: center; }
    .sig-row { display: grid; grid-template-columns: 1fr 1fr; gap: 40px; margin-top: 8px; }
    .sig-block { font-size: 12px; }
    .sig-party { font-family: 'Arial', sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; color: #999; margin-bottom: 48px; }
    .sig-line { border-top: 1px solid #333; margin-bottom: 6px; }
    .sig-label { color: #666; font-size: 11px; }
    .sig-name { font-weight: 700; font-size: 13px; margin-top: 2px; color: #1a1a2e; }
    .sig-date-line { margin-top: 20px; }
    .footer { margin-top: 40px; padding-top: 16px; border-top: 1px solid #eee; text-align: center; font-family: 'Arial', sans-serif; font-size: 10px; color: #bbb; letter-spacing: 0.5px; }
    @media print { body { background: white; padding: 0; } .page { box-shadow: none; padding: 48px 56px; } }
  </style>
</head>
<body>
  <div class="page">
    <div class="header">
      ...
      <div class="doc-meta">
        <strong>Web Design Agreement</strong>
        Date: {{CONTRACT_DATE}}<br>
        Ref: {{CONTRACT_REF}}
      </div>
    </div>
    <div class="title-block">
      <h1>Web Design &amp; Hosting Agreement</h1>
      <p class="subtitle">This agreement is entered into as of {{CONTRACT_DATE}}</p>
    </div>
    <div class="parties-box">
      ...
      <div class="party-row">
        <div class="party">
          ...
          <div class="party-detail">{{CLIENT_BUSINESS}}<br>{{CLIENT_ADDRESS}}</div>
        </div>
        <div class="party">
    ...
    <table class="summary-table">
      <thead>
        <tr>
          <th>Service</th>
          <th>One-off Setup Fee</th>
          <th>Monthly Retainer</th>
          <th>Updates Included</th>
      ...
      <tbody>
        <tr>
          <td>{{SERVICES_SUMMARY}}</td>
          <td><span class="fee-highlight">{{ONE_OFF_FEE}}</span></td>
    ...
    <div class="clauses">
      ...
      <div class="clause"><div class="clause-num">1.</div><div class="clause-text">The Client hereby agrees to engage the Contractor to provide the Client with the following services (the "Services"):<ul><li>{{SERVICES_DETAIL}}</li><li>Design and build of a website comprising up to 5 pages within a single site build.</li><li>Ongoing website hosting and maintenance. The monthly retainer includes: up to {{UPDATES_PER_MONTH}} minor website change(s) per calendar month (such as updating images, contact details, or text); security backup of the website; and ongoing hosting of the website.</li><li>Domain registration and management: {{DOMAIN_HOSTING_INCLUDED}}.</li></ul></div></div>
      ...
      <div class="section-heading">6. Intellectual Property</div>
      <div class="clause"><div class="clause-num">17.</div><div class="clause-text">All intellectual property and related material, including any trade secrets, moral rights, goodwill, relevant registrations or applications for registration, and rights in any patent, copyright, trade mark, trade dress, industrial design and trade name (the "Intellectual Property") that is developed or produced under this Agreement, will be the sole property of the Client. The use of the Intellectual Property by the Client will not be restricted in any manner.</div></div>
      <div class="clause"><div class="clause-num">18.</div><div class="clause-text">The Contractor may not use the Intellectual Property for any purpose other than that contracted for in this Agreement except with the written consent of the Client. The Contractor will be responsible for any and all damages resulting from the unauthorised use of the Intellectual Property.</div></div>
      <div class="section-heading">7. Return of Property</div>
      <div class="clause"><div class="clause-num">19.</div><div class="clause-text">Upon the expiry or termination of this Agreement, the Contractor will return to the Client any property, documentation, records, or Confidential Information which is the property of the Client.</div></div>
      <div class="section-heading">8. Independent Contractor</div>
      <div class="clause"><div class="clause-num">20.</div><div class="clause-text">In providing the Services under this Agreement it is expressly agreed that the Contractor is acting as an independent contractor and not as an employee. The Contractor and the Client acknowledge that this Agreement does not create a partnership or joint venture between them, and is exclusively a contract for service.</div></div>
      <div class="clause-sub-heading"><div class="clause-num"></div><div class="clause-text">Right of Substitution</div></div>
      <div class="clause"><div class="clause-num">21.</div><div class="clause-text">Except as otherwise provided in this Agreement, the Contractor may, at the Contractor's absolute discretion, engage a third party sub-contractor to perform some or all of the obligations of the Contractor under this Agreement and the Client will not hire or engage any third parties to assist with the provision of the Services.</div></div>
      <div class="clause"><div class="clause-num">22.</div><div class="clause-text">In the event that the Contractor hires a sub-contractor:<ul><li>the Contractor will pay the sub-contractor for its services and the Compensation will remain payable by the Client to the Contractor.</li><li>for the purposes of the indemnification clause of this Agreement, the sub-contractor is an agent of the Contractor.</li></ul></div></div>
      <div class="clause-sub-heading"><div class="clause-num"></div><div class="clause-text">Autonomy</div></div>
      <div class="clause"><div class="clause-num">23.</div><div class="clause-text">Except as otherwise provided in this Agreement, the Contractor will have full control over working time, methods, and decision making in relation to provision of the Services in accordance with the Agreement. The Contractor will work autonomously and not at the direction of the Client. However, the Contractor will be responsive to the reasonable needs and concerns of the Client.</div></div>
      <div class="clause-sub-heading"><div class="clause-num"></div><div class="clause-text">Equipment</div></div>
      <div class="clause"><div class="clause-num">24.</div><div class="clause-text">Except as otherwise provided in this Agreement, the Contractor will provide at the Contractor's own expense, any and all tools, machinery, equipment, raw materials, supplies, workwear and any other items or parts necessary to deliver the Services in accordance with the Agreement.</div></div>
      ...
      <div class="clause"><div class="clause-num">33.</div><div class="clause-text">The Contractor will perform regular security backups of the Client's website as part of the monthly retainer. These backups are provided on a best-endeavours basis and are intended to assist with recovery in the event of technical failure. The Client is encouraged to retain their own copies of all important website content and data. The Contractor shall not be liable for any loss, corruption, or deletion of data howsoever caused.</div></div>
...
const DEFAULT_FIELDS = {
  ...
  domainFeeClause: 'Domain registration and annual renewal is included in the monthly retainer.',
  servicesSummary: 'Website design, build & hosting',
  servicesDetail: 'Design, build, and deploy a bespoke brochure website',
};
...
const inputCls = 'w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm text-slate-800 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition';
...
export default function ContractsView() {
  ...
  function generateAndDownload() {
    const replacements = {
      '{{CLIENT_NAME}}': fields.clientName || 'Client Name',
      '{{CLIENT_BUSINESS}}': fields.clientBusiness || '',
      '{{CLIENT_ADDRESS}}': fields.clientAddress || '',
      '{{CONTRACT_DATE}}': fields.contractDate,
      '{{CONTRACT_REF}}': fields.contractRef,
      '{{ONE_OFF_FEE}}': fields.oneOffFee,
      '{{MONTHLY_FEE}}': fields.monthlyFee,
      '{{UPDATES_PER_MONTH}}': fields.updatesPerMonth,
      '{{DOMAIN_HOSTING_INCLUDED}}': fields.domainHostingIncluded,
      '{{DOMAIN_FEE}}': fields.domainFee,
      '{{DOMAIN_FEE_CLAUSE}}': fields.domainFeeClause,
      '{{SERVICES_SUMMARY}}': fields.servicesSummary,
      '{{SERVICES_DETAIL}}': fields.servicesDetail,
    };
    ...
    const safeName = (fields.clientName || 'contract').toLowerCase().replace(/\s+/g, '-');
    a.href = url;
    a.download = `aventra-contract-${safeName}-${fields.contractRef}.html`;
    a.click();
    URL.revokeObjectURL(url);
    setDownloaded(true);
  }

  const required = fields.clientName && fields.clientAddress;
    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h1 className="text-xl font-bold text-slate-800">Generate Contract</h1>
        </div>
        <p className="text-sm text-slate-500">Fill in the details below and download a ready-to-send HTML contract.</p>
      </div>
      ...
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field label="Business Name">
              <input
                ...
                value={fields.clientBusiness}
                onChange={e => set('clientBusiness', e.target.value)}
              />
            </Field>
            <Field label="Client Address *" >
              <input
                className={inputCls}
                placeholder="e.g. 123 High Street, London W1 1AA"
        ...
        {/* Contract info */}
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <h2 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Contract Info</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field label="Reference Number" hint="Used in header & footer">
              <input
                className={inputCls}
                placeholder="e.g. AVN-2026-001"
                value={fields.contractRef}
        ...
        {/* Pricing */}
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <h2 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Pricing</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Field label="Updates per Month">
              <input
                className={inputCls}
                placeholder="e.g. 2"
                value={fields.updatesPerMonth}
                onChange={e => set('updatesPerMonth', e.target.value)}
              />
            </Field>
          </div>
        </div>
        ...
        {/* Domain & Hosting */}
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <h2 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Domain &amp; Hosting</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Domain Hosting">
              <select
                className={inputCls}
                value={fields.domainHostingIncluded}
                onChange={e => set('domainHostingIncluded', e.target.value)}
              >
                <option>Included</option>
                <option>Not included</option>
                <option>Client provides own hosting</option>
              </select>
            </Field>
            <Field label="Domain Fee" hint="Shown in summary table">
              <input
                className={inputCls}
                placeholder="e.g. £10/year included in retainer"
                value={fields.domainFee}
                onChange={e => set('domainFee', e.target.value)}
              />
            </Field>
            <Field label="Domain Fee Clause" hint="Full sentence used in clause 10">
              <input
                className={inputCls}
                placeholder="e.g. Domain registration is included in the monthly retainer."
                value={fields.domainFeeClause}
                onChange={e => set('domainFeeClause', e.target.value)}
              />
            </Field>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          ...
          <div className="space-y-4">
            <Field label="Services Summary" hint="Short label shown in the pricing table">
              <input
                className={inputCls}
                placeholder="e.g. Website design, build & hosting"
                value={fields.servicesSummary}
                onChange={e => set('servicesSummary', e.target.value)}
              />
            </Field>
            <Field label="Services Detail" hint="Full description used in clause 1">
              <textarea
                className={`${inputCls} resize-none`}
                rows={3}
                placeholder="e.g. Design, build, and deploy a bespoke 5-page brochure website including contact form and Google Maps integration."
                value={fields.servicesDetail}
                onChange={e => set('servicesDetail', e.target.value)}
              />
            </Field>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 pb-8">
          ...
          >
            <Download size={15} />
            {downloaded ? 'Downloaded!' : 'Generate & Download'}
          </button>
          <button
            onClick={reset}
            className="flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium text-slate-500 hover:text-slate-700 hover:bg-slate-100 transition-colors"
          >
            <RotateCcw size={14} />
            Reset
          </button>
          {!required && (
            <p className="text-xs text-slate-400">Client name and address are required.</p>
          )}
        </div>
