...
export const api = {
  ...
  updateScheduledEmail: (id, data) => req(`/schedule-email?id=${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
  deleteScheduledEmail: (id)       => req(`/schedule-email?id=${id}`, { method: 'DELETE' }),
};
